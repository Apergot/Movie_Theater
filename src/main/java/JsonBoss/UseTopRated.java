...
public class UseTopRated {
     ...
     * las páginas de la API, pero en principio vamos a probar cómo funciona
     * bien.
     *
     * @return
     * @throws java.net.MalformedURLException
     */
    public List<TopRatedMovie> getTopRatedMovies(int numPag) throws MalformedURLException, IOException {
        ...
        URL newUrl = new URL(newPage + numPag);
        String jsonTR = topRatedJson.getJson(newUrl);
        Gson gson = new Gson();
